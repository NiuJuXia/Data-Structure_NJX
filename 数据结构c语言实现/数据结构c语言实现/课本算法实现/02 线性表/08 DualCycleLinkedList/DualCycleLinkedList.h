...
typedef int LElemType_DC; //双向链表的数据类型

typedef struct DuLNode     //双向链表的结构体
{
    LElemType_DC data;
...
typedef DuLNode* DuLinkList;  //指向双向链表的指针

/*    双循环链表函数列表    */
Status NJXInitList_DuL(DuLinkList *L, int); //等同与DuLNode **L, 创建一个二级指针
/*━━━━━━━━━━┓
┃(01)初始化双链表L。 ┃
┗━━━━━━━━━━*/
